...
/* Feed2JS : RSS feed to JavaScript Configuration include
	Use this include to establish server specific paths and other common functions used by the feed2js.php
	See main script for all the gory details or the Google Code site http://code.google.com/p/feed2js/
	created 10.sep.2004
*/

// MAGPIE SETUP ----------------------------------------------------
// Define path to Magpie files and load library, the easiest setup is to put the 4 Magpie include files in the same directory:
// define('MAGPIE_DIR', './')
// Otherwise, provide a full valid file path to the directory where magpie sites
...
// value of 2 optionally show lots of debugging info but breaks JavaScript This should be set to 0 unless debugging
...
// OTHER SETTIINGS ----------------------------------------------
// Output spec for item date string if used see http://www.php.net/manual/en/function.date.php
$date_format = "F d, Y h:i:s a";

// server time zone offset from GMT
// If this line generates errors (common on Windoze servers, then figure out your time zone offset from GMT and enter manually, e.g. $tz_offset = -7;
