(function () {
    ...
    ui.Pages.define("/pages/headphones/headphones.html", {
        ...
        ready: function (element, options) {
            ...
            var launchURL = "http://" + appData.values['hpIP'] + ":" + appData.values['hpPort'];
        ...
        _initializeLayout: function (listView, viewState) {
            ...
            if (viewState === appViewState.snapped) {
                listView.itemDataSource = HPData.groups.dataSource;
                listView.groupDataSource = null;
                listView.layout = new ui.ListLayout();
            } else {
                listView.itemDataSource = HPData.items.dataSource;
                listView.groupDataSource = HPData.groups.dataSource;
