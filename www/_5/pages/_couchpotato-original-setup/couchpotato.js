(function () {
    ...
    ui.Pages.define("/pages/couchpotato/couchpotato.html", {
        ...
        ready: function (element, options) {
            ...
            // launch button
            var launchURL = "http://" + appData.values['cpIP'] + ":" + appData.values['cpPort'];
            $(".titlearea button.launch-couchpotato").attr("onclick", "location.href='" + launchURL + "'");

            // manage all button
            element.querySelector(".titlearea button.manage-movies").onclick = function () {
                nav.navigate("/pages/couchpotato/manageMovies/manageMovies.html");
            }
        },
        ...
        _itemInvoked: function (args) {
            if (appView.value === appViewState.snapped) {
                ...
                nav.navigate("/pages/couchpotato/cpDetails/cpDetails.html", { item: CPData.getItemReference(item) });
            }
        }
    });
