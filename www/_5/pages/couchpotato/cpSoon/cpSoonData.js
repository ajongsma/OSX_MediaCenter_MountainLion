(function () {
    ...
    function loadCPDataSoon() {
        generateCPDataSoon().then(function (xhr) {
    ...
    WinJS.Namespace.define("CPDataSoon", {
        items: groupedItems,
        ...
        regenerate: regenerateCPDataSoon
    });

    function regenerateCPDataSoon() {
        // redefine list
        list.splice(0, list.length);
        // add new items to list
        loadCPDataSoon();
    }
    regenerateCPDataSoon();
